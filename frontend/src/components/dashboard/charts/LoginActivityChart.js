...
export const LoginActivityChart = ({ data }) => {
  const chartData = useMemo(() => {
    // Group by week_date and calculate average logins
    const weeklyData = {};
      ...
      datasets: [
        {
          ...
          backgroundColor: 'hsla(187, 71%, 38%, 0.1)',
          tension: 0.4,
          pointRadius: 4,
          pointHoverRadius: 6,
          pointBackgroundColor: 'hsl(187, 71%, 38%)',
      ...
      tooltip: {
        ...
        callbacks: {
          label: function(context) {
            return `Average: ${context.parsed.y} logins`;
          }
        }
      }
    },
